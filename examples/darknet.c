...
extern void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *outfile, float thresh, char *filename);
...
int main(int argc, char **argv)
{
    ...
    char* cfgfile = (char*)malloc(sizeof(char) * 200);
    cfgfile = "cfg/yolov3.cfg";
    char* weightsfile = (char*)malloc(sizeof(char) * 200);
    ...
    test_detector("cfg/coco.data", cfgfile, weightsfile, outfile, thresh, filename);
